Tracker.autorun ->
	...
	if Meteor.user() && typeof Meteor.user().learning != 'undefined' and Meteor.user().learning.length == 0 and Router.current and Router.curent() and Router.current().route.name != 'languages'
		Router.go 'languages'
